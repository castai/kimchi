 ...
 * deprecations sit days-to-weeks out. 90 days keeps urgent notices loud and
 * far-future lifespan announcements silent.
 */
const DEPRECATION_NOTIFY_WINDOW_DAYS = 90
